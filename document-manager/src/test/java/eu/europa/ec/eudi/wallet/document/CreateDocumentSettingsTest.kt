...
class CreateDocumentSettingsTest {
    ...
    @Test
    fun `test operator invoke returns a SecureAreaCreateDocumentSettings`() {
        val secureAreaIdentifier = "secureAreaIdentifier"
        ...
        assertEquals(createKeySettings, createDocumentSettings.createKeySettings)
    }
}